...
export class TableChainNodeDefAggregate extends TableSchemaSurvey {
  ...
  readonly formula: Column = new Column(this, 'formula', ColumnType.varchar)

  constructor(surveyId: number) {
    super(surveyId, 'chain_node_def_aggregate')
  }
}
